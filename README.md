...
```
git clone https://github.com/angular/calculator.git
cd calculator
```
...
There are two kinds of tests in the calculator application: Unit tests and end-to-end tests.
...
* the configuration is found at `e2e-tests/protractor-calculatorTests.js`
* the end-to-end tests are found in `e2e-tests/calculatorTests.js`
